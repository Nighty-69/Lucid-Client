...
import com.joojn.client.Event.impl.ChatMessageSendEvent;
import com.joojn.client.Event.impl.OpenContainerEvent;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    {
    	STRING msg = new STRING(message.replace("§", "&"));

        EventCancelable event = new ChatMessageSendEvent(msg);
        event.call();
    ...
    public void displayGUIChest(IInventory chestInventory)
    {
        ...
        new OpenContainerEvent(chestInventory).call();
