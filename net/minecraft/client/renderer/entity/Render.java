...
public abstract class Render<T extends Entity> implements IEntityRenderer {
	 ...
	 */
	protected void renderLivingLabel(T entityIn, String nick, double x, double y, double z, int maxDistance) {
		double d0 = entityIn.getDistanceSqToEntity(this.renderManager.livingPlayer);

		STRING string = new STRING(nick);
		...
		if (d0 <= (double) (maxDistance * maxDistance)) {
			...
			// render player nick event
			if (entityIn instanceof AbstractClientPlayer
					&& entityIn.getDisplayName().getFormattedText().equalsIgnoreCase(string.getString())) {
				EventCancelable event = new RenderPlayerNickEvent(string, entityIn);
				event.call();
			...
			// custom string for interaction from outside
