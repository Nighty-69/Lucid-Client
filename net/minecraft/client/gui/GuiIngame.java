...
import com.joojn.client.Event.impl.RenderScoreboardEvent;
...
public class GuiIngame extends Gui
{
    ...
    private void renderScoreboard(ScoreObjective objective, ScaledResolution scaledRes)
    {
        ...
        for (Score score1 : collection)
        {
            ...
            STRING player = new STRING(ScorePlayerTeam.formatPlayerName(scoreplayerteam1, score1.getPlayerName()));

            EventCancelable event = new RenderScoreboardEvent(player);
            event.call();
            if(event.isCancelled()) continue;

            String s1 = player.getString();
