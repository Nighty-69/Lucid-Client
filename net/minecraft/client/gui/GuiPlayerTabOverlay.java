...
import com.joojn.client.Event.impl.RenderPlayerInTabEvent;
...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn)
    {
        ...
        for (NetworkPlayerInfo networkplayerinfo : list)
        {
            ...
            String formatedName = this.getPlayerName(networkplayerinfo);

            int k = this.mc.fontRendererObj.getStringWidth(formatedName);
            i = Math.max(i, k);
        ...
        for (int k4 = 0; k4 < l3; ++k4)
        {
            ...
            if (k4 < list.size())
            {
                ...
                STRING displayName = new STRING(this.getPlayerName(networkplayerinfo1));
                STRING name = new STRING(networkplayerinfo1.getGameProfile().getName());

                EventCancelable event = new RenderPlayerInTabEvent(displayName, name);
                event.call();
                if(event.isCancelled()) return;

                String s1 = displayName.getString();
                ...
                this.writePing(i1, j2 - (flag ? 9 : 0) + 6, k2 + 1, networkplayerinfo1);
            }
        }
    ...
    protected void writePing(int x1, int x2, int x3, NetworkPlayerInfo networkPlayerInfoIn)
    {
        String pingMessage = String.valueOf(networkPlayerInfoIn.getResponseTime());
        ...
        int offset = font.getStringWidth(pingMessage) - 10;
        font.drawString(pingMessage, x1 + x2 - offset, x3 - 10, pingColor.getRGB(), true);
    }
